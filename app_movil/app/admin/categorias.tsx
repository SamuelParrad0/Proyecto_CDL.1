...
import { crearCategoria, listarCategoriasAdmin, editarCategoria, eliminarCategoria, toggleCategoria } from '@/src/servicios/servicioAdmin';
...
export default function AdminCategoriasScreen() {
  ...
  const { esAdmin, estaAutenticado } = useContext(AuthContext) as any;
  ...
  const confirmarEliminacion = (id: number) => {
    Alert.alert(
      'Eliminar Categoría',
      '¿Estás seguro de que deseas eliminar esta categoría? Si tiene productos asociados podría haber conflictos.',
      [
  ...
  if (!estaAutenticado || !esAdmin) {
    return (
      <View style={styles.restrictedContainer}>
        ...
        <Text style={styles.restrictedSubtitle}>Solo los administradores pueden gestionar categorías.</Text>
      </View>
    );
  }
          ...
          <View style={styles.categoryCard}>
            ...
            <View style={styles.cardActions}>
              ...
              <TouchableOpacity 
                ...
                onPress={() => confirmarEliminacion(item.Id_Categoria!)}
              >
