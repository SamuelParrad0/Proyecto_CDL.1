  ...
  const modulos = [
    {
      ...
      descripcion: 'Administra los productos disponibles, precios, imágenes y estado de visibilidad.',
    ...
    },
    {
      ...
      descripcion: 'Crea y edita paquetes de servicios con precios, descripciones e imágenes.',
      ruta: '/admin/paquetes',
      color: '#3b82f6',
    }
  ];
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.titulo}>Administración de{' '}
            <Text style={styles.textoDorado}>Contenidos</Text>
          </Text>
          <Text style={styles.subtitulo}>Productos de la plataforma</Text>
        </View>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={styles.bannerInfo}>
          <IconSymbol name="doc.text.fill" size={20} color={Tema.dark.dorado || '#c9a060'} />
          <Text style={styles.bannerTexto}>
            Gestiona todo el contenido visible para tus clientes desde aquí.
          </Text>
        </View>
