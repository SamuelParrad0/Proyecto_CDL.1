...
export default function CuentaScreen() {
  ...
  const { usuario, estaAutenticado, esAdmin, logout } = useContext(AuthContext);
    ...
    return (
      <SafeAreaView style={styles.container} edges={['left', 'right']}>
        <View style={styles.noAuthContenedor}>
          ...
          <Text style={styles.noAuthSubtitulo}>Inicia sesión para gestionar tus pedidos, citas y guardar tus direcciones.</Text>
          ...
          <View style={styles.perfilInfo}>
            ...
            {esAdmin && (
              <View style={styles.badgeAdmin}>
                <Text style={styles.badgeAdminTexto}>ADMINISTRADOR</Text>
              </View>
            )}
          </View>
        </View>
        ...
        <View style={styles.seccion}>
          ...
          <View style={styles.tarjeta}>
            <OpcionMenu 
              icono="bag.fill" 
              titulo="Mis Pedidos" 
              subtitulo="Historial y estado de compras"
            ...
            <OpcionMenu 
              icono="calendar" 
              titulo="Mis Citas" 
              subtitulo="Reservas de paquetes"
              onPress={() => router.push('/citas')} 
            />
            <View style={styles.separador} />
            <OpcionMenu 
              icono="wand.and.stars" 
              titulo="Solicitudes Personalizadas" 
              subtitulo="Proyectos a medida"
              onPress={() => router.push('/personalizado')} 
            />
          </View>
        </View>
          ...
          <View style={styles.seccion}>
            ...
            <View style={styles.tarjeta}>
              <OpcionMenu 
                ...
                subtitulo="Gestionar tienda y reservas"
