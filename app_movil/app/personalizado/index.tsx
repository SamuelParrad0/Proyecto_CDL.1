...
export default function MisSolicitudesScreen() {
      ...
      [
        { text: 'No, mantener', style: 'cancel' },
        {
          ...
          onPress: async () => {
            try {
              setCargando(true);
              await servicioPersonalizado.eliminarSolicitud(id);
              await cargarSolicitudes();
              Alert.alert('Éxito', 'La solicitud ha sido eliminada');
            } catch (error) {
  ...
  const renderSolicitud = ({ item }) => {
    const estado = ESTADOS_PERSONALIZADO[item.Estado_Personalizado] || ESTADOS_PERSONALIZADO.pendiente;
    ...
    return (
      <View style={styles.tarjeta}>
        ...
        {item.Estado_Personalizado === 'pendiente' && (
