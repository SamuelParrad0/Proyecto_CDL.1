...
export const URL_BASE_API = 'http://10.0.2.2:5000/api';
...
export const DATOS_FAQ = [
  ...
  },
  {
    ...
    respuesta: 'Sí, puedes agendar una reunión virtual con nosotros. Solo tienes que contactarnos y coordinar el horario que más te convenga.',
  },
  {
    pregunta: '¿Trabajan en todo Bogotá?',
    respuesta: 'Sí, trabajamos en toda Bogotá. Para envíos de productos físicos también tenemos cobertura nacional a todo el territorio colombiano.',
  },
  {
    pregunta: '¿Digitalizan cintas antiguas como VHS o Hi8?',
    respuesta: 'Sí, ofrecemos el servicio de digitalización de medios antiguos, incluyendo cintas VHS, Hi8 y otros formatos.',
  },
  {
    pregunta: '¿Puedo traer mi propia idea o boceto?',
    respuesta: '¡Claro! Si tienes una idea o boceto, podemos trabajar juntos para hacerla realidad.',
  },
  {
    pregunta: '¿Qué tipo de archivo entregan para los videos?',
    respuesta: 'Entregamos videos editados en una USB personalizada y un enlace de descarga en la nube con la mejor calidad disponible.',
  },
  {
    pregunta: '¿Trabajan con contratos o acuerdos escritos?',
    respuesta: 'Sí, trabajamos con contratos o acuerdos escritos para asegurar que todas las condiciones estén claras.',
  },
];
...
export const ESTADOS_PEDIDO = {
  ...
  pagado: { etiqueta: 'Pagado', color: COLORES.info },
  enviado: { etiqueta: 'Enviado', color: COLORES.cyan },
  entregado: { etiqueta: 'Entregado', color: COLORES.exito },
...
export const ESTADOS_CITA = {
  pendiente: { etiqueta: 'Pendiente', color: COLORES.advertencia },
  en_contacto: { etiqueta: 'En contacto contigo', color: COLORES.info },
  agendada: { etiqueta: 'Agendada', color: COLORES.cyan },
  mision_cumplida: { etiqueta: '¡Misión cumplida!', color: COLORES.exito },
};
